...
for i in ["yenojam209@shzsedu.com","supeasdasdrman@gmail.com", "priyanka@gmail.com", "batman@gmail.com", "michael@gmail.com", "raghavdevgon@yahoo.com"]:
    user = i

    #driver.get("https://account.envato.com/sign_up")
    driver.get("https://auth.voxmedia.com/signup?community_id=372&return_to=https://www.theverge.com/")
    ...
    #if "Email is already in use" in p3:
    if "That email address belongs to a registered user." in p3:
        print(i)
    sleep(2)
