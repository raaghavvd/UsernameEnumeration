...
def accountNotPresentLogin(user,link):
    ...
    try:
        ...
        try:
            elem=driver.find_element_by_name("usernameOrEmail")
        except:
            ...
            try:
                ...
                try:
                    elem=driver.find_element_by_name("ap_email")
                except:
                    print("email doesnt exist")
                    try:
                        ...
                        print("email doesnt exist")
                        try:
                            elem=driver.find_element_by_xpath("//*[@id='forgot-password-email']")
                        except:
                            print("email doesnt exist")
                            try:
                                elem=driver.find_element_by_xpath("//*[@id='/html/body/div[2]/div/form/input[2]']")
                            except:
                                print("email doesnt exist")
